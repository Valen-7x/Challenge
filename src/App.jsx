  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-gray-100'>
      ...
      <div className=' flex flex-col items-center rounded-lg p-4 shadow-md bg-gray-300'>
        ...
        />
        <div className='mt-4'>
          <p className='w-[20rem]'>{data?.[currentIndex]?.breeds[0].temperament}</p>
        </div>
        {/* boton implementado con el hook useState */}
        <button onClick={changeImage} className='rounded-full p-2 bg-violet-500 text-white hover:bg-blue-700 transition duration-300'>
          Botón
        </button>
      </div>
    </div>
